<%@ page import="utilitarios.Parametros" contentType="text/html;charset=UTF-8" %>
                ...
                $("#btnDesactivar").click(function () {
                    bootbox.dialog({
                        ...
                        message : "<i class='fa fa-power-off fa-3x pull-left text-shadow'></i>" +
                                  ...
                                  "<ul>" +
                                  "<li>Cerrar el año de proceso ${anio.numero}, por lo que no se podrá crear nuevas actividades este año</li>" +
